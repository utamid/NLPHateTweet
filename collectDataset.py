...
queries = ['@realDonaldTrump', '@pewdiepie','@BarackObama', '@MichelleObama', '@IvankaTrump', '@justinbieber']
...
for query in queries:
    ...
    pprint.pprint(dir(searched_tweets[0]))
    for tweet in searched_tweets:
        if (tweet.lang == 'en' and 'RT' not in tweet.full_text):
            data.append({
